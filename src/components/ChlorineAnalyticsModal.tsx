...
import { parseDateFromRecord } from './ChlorineView';
import { TH_MONTHS, TH_MONTHS_SHORT, EN_MONTHS } from '../utils/equipmentDateUtils';
      ...
      >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`relative w-9 h-9 rounded-xl flex items-center justify-center transition-all cursor-pointer shadow-xs active:scale-95 ${
                isFilterOpen || activeFiltersCount > 0
                  ? 'bg-amber-500 hover:bg-amber-400 text-slate-950 font-black ring-2 ring-amber-300/40 shadow-sm'
            ...
            >
              ...
              {activeFiltersCount > 0 && (
                <span className="absolute -top-1 -right-1 min-w-4 h-4 px-1 rounded-full bg-[#002045] text-amber-300 text-[9px] font-black flex items-center justify-center border border-amber-300/50 shadow-xs">
                  {activeFiltersCount}
                </span>
              )}
            </button>
        ...
        <div className="bg-slate-100/90 border-b border-slate-200 px-4 sm:px-6 py-2 flex flex-wrap items-center justify-between gap-2 shrink-0">
          <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar py-0.5">
            <span className="text-[11px] font-bold text-slate-700 flex items-center gap-1 mr-1 shrink-0">
          ...
          <div className="text-xs text-slate-800 font-bold bg-white px-2.5 py-0.5 rounded-md border border-slate-200 shadow-2xs">
            {timeScopeLabel}
          </div>
        </div>
